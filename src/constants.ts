...
export const ETAPAS_CONFIG: EtapaConfig[] = [
  ...
  { id: 'por_reestimar',             label: 'Por Reestimar',       color: '#f97316', bgColor: '#fff7ed', textColor: '#c2410c' },
...
export const INITIAL_FILTERS: FilterState = {
  ...
  busqueda: '',
  fecha_inicio_estimacion_meses: [],
  fecha_inicio_estimacion_desde: '',
  fecha_inicio_estimacion_hasta: '',
  fecha_fin_estimacion_meses: [],
  fecha_fin_estimacion_desde: '',
  fecha_fin_estimacion_hasta: '',
  fecha_inicio_reestimacion_meses: [],
  fecha_inicio_reestimacion_desde: '',
  fecha_inicio_reestimacion_hasta: '',
  fecha_fin_reestimacion_meses: [],
  fecha_fin_reestimacion_desde: '',
  fecha_fin_reestimacion_hasta: '',
  fecha_inicio_planificada_meses: [],
  fecha_inicio_planificada_desde: '',
  fecha_inicio_planificada_hasta: '',
  fecha_fin_planificada_meses: [],
  fecha_fin_planificada_desde: '',
  fecha_fin_planificada_hasta: '',
};
